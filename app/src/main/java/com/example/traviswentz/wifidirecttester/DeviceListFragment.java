...
/**
 * This class from http://www.programcreek.com/java-api-examples/index.php?source_dir=wifi_p2p-master/src/com/example/pfc_wifip2p/DeviceListFragment.java
 */
            ...
            if (device != null) {
                ...
                if (onedevice != null) {
                    onedevice.setText("Device name: "+device.deviceName+"\nAddress: "+device.deviceAddress+
                            "\nStatus: "+MainActivity.getDeviceStatus(device.status));
                }
            }
            return view;
        }
